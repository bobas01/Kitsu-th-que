...
<body>
    <header>
        ...
        <a id="connexion" href="./connect.php"><img src="./asset//img//icon/icons-connexion.png" alt="connexion"></a></div>
        <div class="search-container">
            <form action="/search">
                <input type="text" placeholder="Rechercher" name="search">
                <button type="submit"><img src="./asset/img/icon/🦆 icon _search_.svg" alt="icon loupe"></button>
            </form>
        </div>
    </header>
</body>
