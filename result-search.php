        ...
        <div class="row-limit-size">
            ...
            if (isset($_GET["search"]) ) {
                ...
                if (!empty($research)) {
                    ...
                    $select_research = $db->prepare("SELECT DISTINCT`manga`.`id`,`manga`.`volume`,`manga`.`title`,`manga`.`cover` FROM `manga` 
                    ...
                    WHERE `manga`.`volume` LIKE :search_term OR `manga`.`author` LIKE :search_term OR `manga`.`title` LIKE  :search_term OR `category`.`slug` LIKE  :search_term OR `genre`.`slug` LIKE  :search_term OR `public`.`slug` LIKE   :search_term ORDER BY :id ;");
